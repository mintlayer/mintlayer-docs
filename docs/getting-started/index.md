...
- [Issue and manage a token](../wallet/guides/issue-new-token.md), create your own MLS-01 token
- [Manage a staking pool](../wallet/guides/managing-a-staking-pool.md), participate in consensus and earn rewards
