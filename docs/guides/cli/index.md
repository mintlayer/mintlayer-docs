...
These guides walk through Mintlayer's main workflows with `wallet-cli`, the interactive command-line wallet. They are the reference versions of the workflows: the [Go](../go/index.md), [JavaScript](../javascript/index.md), [Rust](../rust/index.md), and [Python](../python/index.md) guides implement the same flows in code.
