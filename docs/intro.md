...
- **Build dApps**, integrate wallets with the [JavaScript SDK](build/sdks/javascript/index.md), [Rust](build/sdks/rust/index.md) or [Python](build/sdks/python/index.md) SDKs, or [Mojito Inject](build/mojito-inject.md), and query chain data via the [API](api/index.md).
...
| [Guides](guides/index.md) | Tokens, NFTs, staking, orders, atomic swaps: wallet-cli, Go, JavaScript, Rust, Python |
| [Build](build/index.md) | SDKs (JavaScript, Go, Rust, Python), developer guides, Mojito Inject, MCP, Bridge |
