...
Delegations are created and switched between pools through the wallet (see [delegation commands](../../wallet/cli/commands/staking/delegation-create-command-guide.md) and the [staking guide](../../guides/cli/managing-a-staking-pool.md)).
