---
title: Mojito Inject
description: Connect your dApp to the user's Mojito wallet through the window.mojito browser-extension provider.
sidebar_position: 5
---

# Getting Started with `window.mojito`

The [Mojito Wallet](../wallet/mojito-wallet.md) browser extension injects a global object `window.mojito` into every page. This object acts as a lightweight interface between your decentralized app (dApp) and the Mojito wallet, allowing you to request access, send transactions, and react to wallet state changes.
